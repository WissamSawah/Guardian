...
<br><h2 style="text-align:center; color: #004a99;">Hello ' . $first_name . '! </h2>
  <p style="line-height: 1.9rem; text-align:center;"> We have received your message and would like to thank you for writing to us. If your inquiry is urgent, please use the phone number listed below to talk to one of our staff members. Otherwise, we will reply by email as soon as possible. </p>
  <br>
  <p style=" text-align:center;">Best Regards</p>
  <p style=" text-align:center;"> Guardian Team </p>
...
$headers2 .= "From: Guardian Contact request! <support@ride-guardian.com> \r\n";
...
// If we passed all previous tests, send the email then redirect to the thank you page.
	...
	mail( "$webmaster_email", "Contact request from Ride-guardian.com!", $msg, $headers2 );
